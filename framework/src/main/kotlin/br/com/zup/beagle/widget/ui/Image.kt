...
sealed class ImagePath(val url: Bind<String>?, val placeholder: Local? = null) {
    constructor(url: String? = null, placeholder: Local? = null) : this(constantOfNullable(url), placeholder)
    ...
    class Local internal constructor(webUrl: Bind<String>?, val mobileId: Bind<String>?) : ImagePath(webUrl) {
        companion object {
            fun both(webUrl: String, mobileId: String) = Local(constantOfNullable(webUrl), constantOfNullable(mobileId))
            fun justMobile(mobileId: String) = Local(null, constantOfNullable(mobileId))
            fun justWeb(webUrl: String) = Local(constantOfNullable(webUrl), null)
