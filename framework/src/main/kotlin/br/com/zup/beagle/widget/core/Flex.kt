...
data class EdgeValue(
    ...
    companion object {
        ...
        private fun createUnitValueIfValueNotNull(value: Double?, unitType: UnitType): UnitValue? {
            ...
            return UnitValue(constant(value), unitType)
        }
        ...
        fun all(all: Int,
            ...
            EdgeValue(all = UnitValue(constant(all.toDouble()), unitType))
        ...
        fun all(all: Double,
                unitType: UnitType = UnitType.REAL): EdgeValue =
            EdgeValue(all = UnitValue(constant(all), unitType))
        ...
        fun horizontal(horizontal: Int,
                       unitType: UnitType = UnitType.REAL): EdgeValue =
            EdgeValue(horizontal = UnitValue(constant(horizontal.toDouble()), unitType))
        ...
        fun horizontal(horizontal: Double,
                       unitType: UnitType = UnitType.REAL): EdgeValue =
            EdgeValue(horizontal = UnitValue(constant(horizontal), unitType))
        ...
        fun vertical(vertical: Int,
                     unitType: UnitType = UnitType.REAL): EdgeValue =
            EdgeValue(vertical = UnitValue(constant(vertical.toDouble()), unitType))
        ...
        fun vertical(vertical: Double,
                     unitType: UnitType = UnitType.REAL): EdgeValue =
            EdgeValue(vertical = UnitValue(constant(vertical), unitType))
    }
}
